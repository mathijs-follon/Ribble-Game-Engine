        ...
        switch (event.type) {
            ...
            case SDL_EVENT_KEY_UP: {
                ...
                if (pressed) {
                    ...
                    m_windowEventBus->dispatch_immediate(std::make_shared<KeyUpEvent>(key, mods, event.key.scancode));
                }
                break;
            }
            ...
            case SDL_EVENT_MOUSE_WHEEL:
                m_windowEventBus->dispatch_immediate(std::make_shared<MouseScrollEvent>(event.wheel.x, event.wheel.y));
                break;
            ...
            case SDL_EVENT_GAMEPAD_BUTTON_UP: {
                ...
                m_windowEventBus->dispatch_immediate(std::make_shared<GamepadButtonEvent>(
                        ...
                        sdl_gamepad_button_to_ribble(static_cast<SDL_GamepadButton>(event.gbutton.button)), action));
                break;
            }
